...
class Planner:
    ...
    def build_landmark_graph(self, final_goal):
        ...
        # print(dists.shape[1])
        # print(torch.zeros(len(final_goal), dists.shape[1], device=self.agent.device)-100000)
    ...
    def __call__(self, cur_obs, cur_ag, final_goal, agent, replay_buffer, novelty_pq):
        ...
        if self.env != "AntMazeSparse" and torch.any(dist_direct_goal > self.goal_thr):
